...
function Contactme() {
    ...
    return (
        <div className='flex flex-col md:flex-row items-center gap-10 mt-20 mx-20 ' id="contactme">
            <div className='border-2 border-black opacity-80  bg-bg  flex-1 p-4 rounded py-10'>
            ...
            <form ref={form} className='flex flex-col gap-10 flex-1  w-full'>
                <input className="bg-bg border-2 border-black placeholder-gray-400 rounded w-full py-2 px-4  leading-tight outline-none  "
                    placeholder='Name'
                    name="name"
                />
                <input className="bg-bg border-2 border-black placeholder-gray-400 rounded w-full py-2 px-4  leading-tight outline-none  "
                ...
                <input className="bg-bg border-2 border-black placeholder-gray-400 rounded w-full py-2 px-4  leading-tight outline-none  "
                    ...
                    name="subject"
                />
                <textarea className="bg-bg  border-2 border-black h-[200px] placeholder-gray-400 rounded w-full py-2 px-4  leading-tight outline-none  "
